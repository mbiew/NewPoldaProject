 ...
 * @author mbiieww
 */
public class buatDataKorban extends javax.swing.JFrame {

    Connection konek;
    
    public buatDataKorban() {
        initComponents();
...
//        koneksi = SqliteKoneksi.connect();
     ...
     public void tambahData(){
        ...
        try {
            ...
            String query = "INSERT INTO tbl_data_korban (jenis_identitas,no_identitas,nama_lengkap,tempat_lahir,tgl_lahir,jenis_kelamin,nama_ibu,nama_bapak,nama_alias,agama,pendidikan,pekerjaan,kewarganegaraan,nama_negara,no_telepon,alamat_email)"
    ...
    private void initComponents() {
        ...
        tf5.setBorder(null);
        jPanel1.add(tf5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 556, 690, 20));

        tf6.setBorder(null);
        jPanel1.add(tf6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 606, 690, 20));

        tf7.setBorder(null);
        jPanel1.add(tf7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 656, 690, 20));

        tf8.setBorder(null);
        jPanel1.add(tf8, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 710, 690, 20));
        ...
        tf10.setBorder(null);
        jPanel1.add(tf10, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 914, 690, 20));
        ...
        jPanel1.add(tf11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 964, 690, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/app_inventory_direktorat/img/Web 1366 – 20_2.png"))); // NOI18N
 ...
 FilterAngka(evt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buatDataKorban.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buatDataKorban().setVisible(true);
            }
        });
    }
