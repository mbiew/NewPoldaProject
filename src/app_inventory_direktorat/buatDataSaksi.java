 ...
 * @author mbiieww
 */
public class buatDataSaksi extends javax.swing.JFrame {

    Connection konek;
    
    public buatDataSaksi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tf10.setBorder(null);
        jPanel1.add(tf10, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 914, 680, 20));
        ...
        jPanel1.add(tf11, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 964, 680, 20));
        ...
        rb3.setText(" WNI");
        jPanel1.add(rb3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 860, 60, -1));
        ...
        jPanel1.add(rb4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 860, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/app_inventory_direktorat/img/Web 1366 – 21_1.png"))); // NOI18N
 ...
 FilterAngka(evt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buatDataSaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buatDataSaksi().setVisible(true);
            }
        });
    }
